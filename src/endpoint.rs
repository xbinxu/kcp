...
#[derive(Debug)]
pub(crate) struct EndpointDriver<S: proto::crypto::Session>(pub(crate) EndpointRef);
...
#[derive(Debug)]
pub struct Incoming<S: proto::crypto::Session>(EndpointRef);
...
impl EndpointRef
{
    pub(crate) fn new(socket: UdpSocket, inner: proto::generic::Endpoint, ipv6: bool) -> Self {
